  ...
  <div>
    <v-list-tile :key="notification.title">
      <v-list-tile-content>
        ...
        <v-list-tile-sub-title class="notification-wrap">{{ notification.message }}</v-list-tile-sub-title>
      </v-list-tile-content>

      <v-list-tile-action>
        <v-list-tile-action-text>{{ getTimeSince(notification.timestamp) }}</v-list-tile-action-text>
        <div>
          <v-btn
            href
            flat
