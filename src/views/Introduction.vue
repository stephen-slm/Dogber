  ...
  <v-stepper v-model="e1">
    ...
    <v-stepper-items>
      <v-stepper-content step="1">
        ...
        <p style="text-align:center">Welcome to Dogber! Thank you for joining our platform, to complete 
              your application we require extra information. This will help us to create your profile</p>
    ...
    <v-expansion-panel-content>
      ...
      <v-card>
          <p style="text-align:center">This part is optional, if you have any dogs 
              and would like to add them in your profile</p>
      ...
      <v-flex xs6>
        <v-card>
          <v-card-text>Your Dogs added</v-card-text>
           <v-container grid-list-md text-xs-center>
              <v-layout row wrap>
                  <v-flex xs6 v-for="dog in dogInformation"
                  :key="dog">
      ...
      <v-stepper-content step="4">
        ...
        <v-flex xs6>
            ...
            publishing any  Website material in any media; selling, sublicensing and/or otherwise 
            commercializing any Website material;   publicly performing and/or showing any Website 
            material; using this Website in any way that is, or may be, damaging to this Website; 
            using this Website in any way that impacts user access to this Website; using this Website 
            contrary to applicable laws and regulations, or in a way that causes, or may cause, harm to 
            the Website, or to any person or business entity; engaging in any data mining, data harvesting, 
            data extracting or any other similar activity in relation to this Website, or while using this Website; 
            using this Website to engage in any advertising or marketing;
            Certain areas of this Website are restricted from access by you and DOGBER may further restrict access 
            by you to any areas of this Website, at any time, in its sole and absolute discretion.  Any user ID and password 
            you may have for this Website are confidential and you must maintain confidentiality of such information.</p>
               </v-flex>
        </v-layout>
